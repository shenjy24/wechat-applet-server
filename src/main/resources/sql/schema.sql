...
(
    `appid`        varchar(64)   NOT NULL COMMENT '微信小程序标识',
    `access_token` varchar(1024) NOT NULL COMMENT '微信服务端的通信凭证',
    `expire_time`  datetime DEFAULT NULL COMMENT '创建时间',
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='微信小程序应用信息表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='快递100信息表';
